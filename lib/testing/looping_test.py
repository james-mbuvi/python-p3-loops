...
class TestHappyNewYear:
    ...
    def test_prints_10_to_1_hny(self):
        ...
        assert remaining_digits == [], "You didn't print all digits 1-10, missing {', '.join(remaining_digits)}"
    ...
    def test_prints_1_to_100_fizzbuzz(self):
        ...
        for line in answer.split('\n'):
            if(line): #answer.split(\n) produces a list that ends in ''
                if i % 15 == 0: assert line == "FizzBuzz", "Should have printed 'Buzz' when number is {i}, got {line} instead"
                elif i % 3 == 0: assert line == "Fizz", "Should have printed 'Fizz' when number is {i}, got {line} instead"
                elif i % 5 == 0: assert line == "Buzz", "Should have printed 'Buzz' when number is {i}, got {line} instead"
                else: assert str(i) == line, "Should have printed {i}, got {line} instead"
                i += 1
        
        i = i - 1
        assert i == 100, "Only looped {i} times, should have looped 100 times. Check your loop condition!"    
